...
PROMPT_V1_NAME = "my-rag-prompt-v1-openai"
PROMPT_V2_NAME = "my-rag-prompt-v2-openai"
...
def main():
    print("=" * 60)
    print("  Step 2: Prompt Hub A/B Routing (OpenAI Edition)")
    print("=" * 60)
    ...
    print(f"\nRouting Summary: V1 routed {v1_count} times, V2 routed {v2_count} times.")
