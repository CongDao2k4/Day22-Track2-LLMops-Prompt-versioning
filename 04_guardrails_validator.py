...
# Thư viện core Guardrails 0.5.0 có thể có OnFailAction ở các đường dẫn khác nhau
try:
...
class JSONFormatter(Validator):
    ...
    def validate(self, value: str, metadata: dict = {}):
        ...
        try:
            ...
            error_obj = {"error": f"Invalid JSON after repair attempt: {e}", "raw": value}
            return FailResult(
                error_message=f"Invalid JSON after repair attempt: {e}",
                fix_value=json.dumps(error_obj)
            )
